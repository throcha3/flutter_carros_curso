...
class DatabaseHelper {
  ...
  void _onCreate(Database db, int newVersion) async {
    ...
    String s = "CREATE TABLE carro(id INTEGER PRIMARY KEY, tipo TEXT, nome TEXT, descricao TEXT, urlFoto TEXT, urlVideo TEXT, latitude TEXT, longitude TEXT);    CREATE TABLE favorito(id INTEGER PRIMARY KEY, nome TEXT)";
